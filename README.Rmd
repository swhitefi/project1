...
```
Jhansi also looked at the effect of the adaptive immune system on *C diff* infection. She infected mice with *C diff* strain 630, compared the level of colonization of wildtype vs. RAG knockout mice over time. RAG knockout mice have no mature B and T lymphocytes, so they are severly immuno defficient. 
