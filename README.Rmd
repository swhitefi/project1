...
plot(sortedreshapecfu$CFU~sortedreshapecfu$Day, type="p")
points(40,3.26e+05, pch=6, col="red")

plot(sortedreshapecfu[sortedreshapecfu$genotype=="RAG","CFU"]~sortedreshapecfu[sortedreshapecfu$genotype=="RAG","Day"], type="p", col="green", pch=15, log="y", main="RAG and WT 630 Colonization Over Time", xlab="Day", ylab="Titer(630CFU/gram feces)")
#adding WT mice
...
#adding control
lines(sortedreshapecfu[sortedreshapecfu$treatment=="c","CFU"]~sortedreshapecfu[sortedreshapecfu$treatment=="c","Day"], type="l", col="black")
#connecting the mice
#1
