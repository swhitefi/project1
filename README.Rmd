...
summary(mousecfu)
#reading in mean cfu datafile
meanmousecfu<-read.table(file="")
...
stripchart(mousecfu[mousecfu$genotype=="RAG", "pBLweight"]~mousecfu[mousecfu$genotype=="RAG","infection_status"], method ="jitter", vertical=F, pch=c(1), col="green", ylab="Percent of baseline weight", xlab="Colonization Status Prior to VPI Infection")
stripchart(mousecfu[mousecfu$genotype=="WT", "pBLweight"]~mousecfu[mousecfu$genotype=="WT","infection_status"], method ="jitter", vertical=F, pch=c(1), col="blue", ylab="Percent of baseline weight", xlab="Colonization Status Prior to VPI Infection", add=T)



points(mousecfu[mousecfu$genotype=="WT", "pBLweight"]~mousecfu[mousecfu$genotype=="WT","infection_status"], col="blue", pch=c(1))
